...
class dashboard(yt_analysis):
    ...
    def board(self):
        ...
        app.layout = html.Div(children=[
            ...
            html.Div(children='''This dash is A web application framework to visualize and analyze different youtube channels either random ones or chosing a specific ones through entering  the inputs (e.g channel username)) '''),

            html.Label('Select Inputs to Enter:'),

           

            html.Label('Enter the selected inputs:'),
            ...
            dash_table.DataTable(data=self.data, page_size=6),
        ...
        def update_graph(col_chosen):
            fig = px.histogram(self.data, x='channel_name', y=col_chosen, histfunc='avg')
        ...
        def update_graph(col_chosen):
            ...
            fig2= px.pie(self.data, values=col_chosen, names='channel_name')
            return fig2
        @callback(
...
ds = dashboard(maxResults=25,keyword='cheb khaled')
ds.board()
